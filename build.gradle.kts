...
paperweight {
    serverProject.set(project(":floki-server"))
    ...
    usePaperUpstream(providers.gradleProperty("paperRef")) {
        withPaperPatcher {
            ...
            apiOutputDir.set(layout.projectDirectory.dir("floki-api"))

            serverPatchDir.set(layout.projectDirectory.dir("patches/server"))
            serverOutputDir.set(layout.projectDirectory.dir("floki-server"))
        }
    }
}
...
tasks.generateDevelopmentBundle {
    apiCoordinates.set("com.floki.paper:floki-api")
...
publishing {
    ...
    // ./gradlew publishDevBundleToMavenLocal -PpublishDevBundle=tru
